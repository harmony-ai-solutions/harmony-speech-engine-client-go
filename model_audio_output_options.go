...
type _AudioOutputOptions AudioOutputOptions
...
func (o *AudioOutputOptions) UnmarshalJSON(data []byte) (err error) {
	varAudioOutputOptions := _AudioOutputOptions{}

	err = json.Unmarshal(data, &varAudioOutputOptions)

	if err != nil {
		return err
	}

	*o = AudioOutputOptions(varAudioOutputOptions)
